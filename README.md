...
This effort has been made as a Computer Engineering [bachelor's thesis](https://github.com/simdeistud/bachelors-thesis) in the context of the **_Digital Systems Architectures_** course held at the **_Department of Engineering and Architecture_** at the **_[University of Trieste](https://www.units.it/en)_** under the guidance of _**Prof. Alberto Carini**_ .
